...
class Home extends Component {
    ...
    render() {
        ...
        const trainingList = this.props.trainings ? this.props.trainings.map(training => (
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles, listStyles)(Home));
